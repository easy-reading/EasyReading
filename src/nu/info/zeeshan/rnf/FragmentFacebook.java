...
public class FragmentFacebook extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
		...
		feed_url=spf.getString(getString(R.string.pref_facebookrss), getString(R.string.empty_feed));
		String[] select = { 
				DbStructure.FeedTable._ID,
		...
		Cursor c = new DbHelper(getActivity()).getReadableDatabase().query(
				DbStructure.FeedTable.TABLE_NAME, select, "type=2", null,
				null, null, DbStructure.FeedTable.COLUMN_TIME);
		adapter=new FbAdapter(getActivity(),c);
